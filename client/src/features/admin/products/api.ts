...
import type { Category, CreateCategoryBody, CreateProductBody, Product, UpdateProductBody } from "./type";
...
export function updateAdminCategory(id: string, body: CreateCategoryBody) {
    return apiPut<Category, CreateCategoryBody>(`/admin/categories/${id}`, body)
}
...
export function getAdminSingleProduct(productId: string) {
